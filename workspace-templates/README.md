...
| [adaptive-math-learning-agent/](./adaptive-math-learning-agent/) | 中小学数学错因诊断、多表征修复与自适应巩固 | math-task-structurer / math-reasoning-trace-analyzer / math-misconception-verifier / multi-representation-repair / adaptive-math-practice / math-learning-progress-reporter | ✅ 可用 |
